...
public class Professor implements Serializable {
    ...
    public Professor(Long id, String cpf, String rg, Date dataDeNascimento, char sexo, String email, String telefone, String endereco, String nome, char estado, Funcionario responsavelPeloCadastro) {
        this.id = id;
        this.cpf = cpf;
        this.rg = rg;
